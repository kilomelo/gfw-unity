namespace UnityGameFramework.Runtime
{
    public class UGFIF
    {
        ...
        /// 获取代码热更组件。
        /// </summary>
        public static HotfixAssemblyComponent HotfixAssembly => _hotfixAssembly ??= GameEntry.GetComponent<HotfixAssemblyComponent>();
        private static HotfixAssemblyComponent _hotfixAssembly;
    }
}